...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml
--  Ran at: 1/17/25, 3:34 PM
--  Against: null@offline:mysql?changeLogFile=/Users/dragusa/work/domibus_sql/domibus-sql/domibus-msh-sql-scripts/target/liquibase/changelog-1.8.mysql
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7836::gautifr
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-quartz.xml::EDELIVERY-3425::migueti
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-4740::idragusa
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-UserMessage Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-Miscellaneous Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-PMode Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-Alert Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-8450::Francois Gautier
...
ALTER TABLE TB_EARCHIVEBATCH_UM ADD CONSTRAINT FK_EARCHIVE_BATCH_ID_FTR FOREIGN KEY (FK_EARCHIVE_BATCH_ID) REFERENCES TB_EARCHIVE_BATCH (ID_PK) ON UPDATE RESTRICT ON DELETE CASCADE;
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-Backend Filter Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-7803-User/Plugin User Tables::Cosmin Baciu
...
CREATE TABLE TB_USER_ROLES (USER_ID BIGINT NOT NULL, ROLE_ID BIGINT NOT NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL);
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-4669::dussath
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-8503_1::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-8532::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-9563::Razvan Cretu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-9686::Lucian Furca
ALTER TABLE TB_PM_SECURITY ADD PROFILE VARCHAR(255) NULL;

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-10091::Soumya Chandran 
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-11509::idragusa
CREATE INDEX IDX_SIG_MESS_SIGNAL_MESS_ID ON TB_SIGNAL_MESSAGE(SIGNAL_MESSAGE_ID);

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-12066::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::12066-1::Cosmin Baciu
CREATE INDEX IDX_DDC_FINAL_RECIPIENT ON TB_DDC_LOOKUP(FINAL_RECIPIENT);

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog.xml::EDELIVERY-11796-add-pks-mysql::Gabriel Maier
