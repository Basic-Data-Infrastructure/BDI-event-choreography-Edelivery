...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml
--  Ran at: 1/17/25, 3:34 PM
--  Against: null@offline:mysql?changeLogFile=/Users/dragusa/work/domibus_sql/domibus-sql/domibus-msh-sql-scripts/target/liquibase/changelog-1.8-data.mysql
--  Liquibase version: 4.17.0
--  *********************************************************************

--  Changeset src/main/resources/db/releases/5.1.6/../../common/changelog-before-migration-statements-v2.xml::EDELIVERY-12287_assert_previous_migration_succeeded-v2-mysql::Gabriel Maier
DELIMITER //
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-2144_1::thomas dussart
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-7368::ionperpegel
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-7836-insert::idragusa
INSERT INTO TB_USER_MESSAGE (ID_PK, MSH_ROLE_ID_FK) VALUES ('19700101', '197001010000000001');

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-8503_2::ion perpegel
INSERT INTO TB_LOCK (ID_PK, LOCK_KEY) VALUES ('197001010000000001', 'bootstrap-synchronization.lock');

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-9451::ion perpegel
INSERT INTO TB_LOCK (ID_PK, LOCK_KEY) VALUES ('197001010000000002', 'scheduler-synchronization.lock');

--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::insert_last_pk_in_TB_EARCHIVE_START::gautifr
...
--  Changeset src/main/resources/db/releases/5.1.6/5.1.6-changelog-data.xml::EDELIVERY-11903::Cosmin Baciu
INSERT INTO TB_LOCK (ID_PK, LOCK_KEY) VALUES ('197001010000000003', 'keystore-synchronization.lock');

--  Changeset src/main/resources/db/releases/5.1.6/../../common/changelog-version-inserts.xml::EDELIVERY-7668-mysql::Catalin Enache
INSERT INTO TB_VERSION (VERSION, BUILD_TIME, CREATION_TIME) VALUES ('5.1.6', '2025-01-17 13:34', (UTC_TIMESTAMP))
            ON DUPLICATE KEY UPDATE BUILD_TIME='2025-01-17 13:34', CREATION_TIME = (UTC_TIMESTAMP);
