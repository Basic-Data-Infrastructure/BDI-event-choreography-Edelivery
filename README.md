...
- [ ] Send a “hello world” message from one deployment of a common open source e-delivery such as [Domibus](https://github.com/cefedelivery/domibus) to another deployment; compare steps to steps of deploying a custom web-based integration without e-delivery. Work in progress: [Deploying an e-delivery access point](deployment.md).
